...
// /___/   /\     Timestamp : 01/31/2026 01:21:12
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/Desktop/EE533_lab3_op/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   FD8CE_MXILINX_dropfifo XLXI_41 (.C(clk), 
                                   .CE(XLXN_25), 
                                   .CLR(rst), 
                                   .D(XLXN_11[7:0]), 
                                   .Q(XLXN_208[7:0]));
   // synthesis attribute HU_SET of XLXI_41 is "XLXI_41_17"
   COMP8_MXILINX_dropfifo XLXI_42 (.A(XLXN_11[7:0]), 
                                   .B(XLXN_7[7:0]), 
                                   .EQ(XLXN_49));
   // synthesis attribute HU_SET of XLXI_42 is "XLXI_42_18"
   COMP8_MXILINX_dropfifo XLXI_43 (.A(XLXN_7[7:0]), 
                                   .B(XLXN_208[7:0]), 
                                   .EQ(XLXN_14));
   // synthesis attribute HU_SET of XLXI_43 is "XLXI_43_19"
   CB8CLE_MXILINX_dropfifo XLXI_44 (.C(clk), 
                                    .CE(XLXN_32), 
                                    .CLR(rst), 
                                    .D(XLXN_208[7:0]), 
                                    .L(XLXN_28), 
                                    ...
                                    .Q(XLXN_11[7:0]), 
                                    .TC());
   // synthesis attribute HU_SET of XLXI_44 is "XLXI_44_20"
   CB8CE_MXILINX_dropfifo XLXI_45 (.C(clk), 
                                   .CE(XLXN_16), 
                                   .CLR(rst), 
                                   .CEO(), 
                                   .Q(XLXN_7[7:0]), 
                                   .TC());
   // synthesis attribute HU_SET of XLXI_45 is "XLXI_45_21"
   FDC XLXI_46 (.C(clk), 
                .CLR(rst), 
                .D(XLXN_16), 
                .Q(valid_data));
   defparam XLXI_46.INIT = 1'b0;
   reg9B XLXI_47 (.ce(XLXN_146), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_10[71:0]));
   OR2 XLXI_48 (.I0(XLXN_17), 
                .I1(XLXN_18), 
                .O(XLXN_4));
   AND2B1 XLXI_49 (.I0(XLXN_28), 
                   .I1(XLXN_4), 
                   .O(XLXN_25));
   AND3B2 XLXI_50 (.I0(XLXN_14), 
                   .I1(XLXN_49), 
                   .I2(fiforead), 
                   .O(XLXN_16));
   dualportmemory XLXI_51 (.addra(XLXN_11[7:0]), 
                           .addrb(XLXN_7[7:0]), 
                           .clka(clk), 
                           .clkb(clk), 
                           .dina(XLXN_10[71:0]), 
