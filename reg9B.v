...
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/Desktop/EE533_lab3_op/reg9B.sch" reg9B.vf
//Design Name: reg9B
//Device: virtex2p
//Purpose:
...
module reg9B(ce, 
   ...
   FD16CE_MXILINX_reg9B XLXI_10 (.C(clk), 
                                 .CE(ce), 
                                 .CLR(clr), 
                                 .D(d[15:0]), 
                                 .Q(q[15:0]));
   // synthesis attribute HU_SET of XLXI_10 is "XLXI_10_3"
   FD8CE_MXILINX_reg9B XLXI_11 (.C(clk), 
                                .CE(ce), 
                                .CLR(clr), 
                                .D(d[71:64]), 
                                .Q(q[71:64]));
